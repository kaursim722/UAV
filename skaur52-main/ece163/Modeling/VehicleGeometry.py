from ..Utilities import MatrixMath as matrix1
...
class VehicleGeometry():
	...
	def getNewPoints(self, x, y, z, yaw, pitch, roll):
		...
		dcmMatrix = Rotations.euler2DCM(yaw, pitch, roll)

		newPoints = matrix1.multiply(newPoints, dcmMatrix)
		new_matrix = matrix1.offset(newPoints, x, y, z)
		finalNewPoints = Rotations.ned2enu(new_matrix)
